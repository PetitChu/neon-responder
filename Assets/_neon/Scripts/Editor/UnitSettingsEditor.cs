...
namespace BeatEmUpTemplate2D {
        ...
        private HashSet<string> unitNameFieldsPlayer = new HashSet<string> { "playerId", "unitName", "unitPortrait", "showNameInAllCaps" };
        ...
        public void showInfo(int id, UNITTYPE unitType){
            ...
            case 10:
                ...
                if(unitType == UNITTYPE.PLAYER) content += highlightItem("Player Id: ") + "A variable used to identify this unit." + newline;
